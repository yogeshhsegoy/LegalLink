  ...
  return (
    <div className='text-black w-full mr-2 ml-2'>
      <div className='w-full py-6 bg-gray-700 rounded-md md:text-[12px] mt-4 p-4'>
        <h2 className='sm:text-md md:text-2xl font-bold text-white mb-4'>Add Income</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Finalized Fee:</label>
            <input
              type='number'
              value={finalizedFee}
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Fee Paid:</label>
            <input
              type='number'
              value={feePaid}
