...
const Dashboard = () => {
    ...
    return (
        <div className='text-white w-full h-screen' >
            {load ? (
                <>
                    <p className='p-4 text-xl md:text-2xl lg:text-3xl text-black'>Dashboard</p>
                    <div className='flex flex-col md:flex-row flex-wrap'>
                        <div className='w-48 h-28 md:w-52 md:h-32 bg-gray-500 ml-4 my-4 md:mx-10 md:my-4 rounded-md flex justify-between items-center'>
                            <div className='pl-2'>
                                <p className='text-3xl '>{clients}</p>
                                <p className='text-gray-800 text-2xl font-bold'>Clients</p>
                                <p className='text-black'>Total clients</p>
                            </div>
                            <div className='pr-2'>
                        ...
                        <div className='w-48 h-28 md:w-52 md:h-32 bg-gray-500 ml-4 my-4 md:mx-10 md:my-4 rounded-md flex justify-between items-center'>
                            <div className='pl-2'>
                                <p className='text-3xl '>{cases}</p>
                                <p className='text-gray-800 text-2xl font-bold'>Cases</p>
                        ...
                        <div className='w-48 h-28 md:w-52 md:h-32 bg-gray-500 ml-4 my-4 md:mx-10 md:my-4 rounded-md flex justify-between items-center'>
                            <div className='pl-2'>
                                ...
                                <p className='text-gray-800 text-2xl font-bold'>Income</p>
