        ...
        <>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4 mt-4'>
            {caseList.map((caseItem, index) => (
              ...
              >
                <p className='font-bold text-lg mb-2'>{caseItem.ClientName}</p>
                <p>{caseItem.CaseDetail}</p>
                <p>{caseItem.CourtDetail}</p>
                <p>{caseItem.PetitionervsRespondent}</p>
                <p>{caseItem.Sections}</p>
                <p>{caseItem.Status}</p>
              </div>
            ))}
          </div>
