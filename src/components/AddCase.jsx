  ...
  return (
    <div className='text-black w-full mr-2 ml-2'>
      <div className='w-full py-6 bg-gray-700 rounded-md md:text-[12px] mt-4 p-4'>
        <h2 className='sm:text-md md:text-2xl font-bold text-white mb-4'>Add Case</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          <div className='mb-4 sm:text-sm  md:text-xl'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Client Name:</label>
            <input
              type='text'
              value={clientName}
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Case Detail:</label>
            <input
              type='text'
              value={caseDetail}
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Court Detail:</label>
            <input
              type='text'
              value={courtDetail}
          ...
          <div className='mb-4'>
            <label className='text-white text-base sm:text-sm md:text-xl'>Petitioner vs Respondent:</label>
            <input
              type='text'
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Sections:</label>
            <input
              type='text'
              value={sections}
          ...
          <div className='mb-4'>
            <label className='sm:text-sm md:text-xl text-white text-base'>Status:</label>
            <input
              type='text'
              value={status}
