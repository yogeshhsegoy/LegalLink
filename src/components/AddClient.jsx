...
const AddClient = () => {
    ...
    return (
        <div className='text-black w-full mr-2 ml-2'>
            ...
            <div className='w-full py-6 bg-gray-700 rounded-md md:text-[12px] mt-4 p-4'>
                <h2 className='sm:text-md md:text-2xl font-bold text-white mb-4'>Add Client</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                    <div className='mb-4 sm:text-sm md:text-xl'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>First Name:</label>
                        <input
                            type='text'
                            value={firstName}
                    ...
                    <div className='mb-4'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>Middle Name:</label>
                        <input
                            type='text'
                            value={middleName}
                    ...
                    <div className='mb-4'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>Last Name:</label>
                        <input
                            type='text'
                            value={lastName}
                    ...
                    <div className='mb-4'>
                        <label className='text-white text-base sm:text-sm md:text-xl'>Age:</label>
                        <input
                            type='number'
                            value={age}
                    ...
                    <div className='mb-4'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>Gender:</label>
                        <input
                            type='text'
                            value={gender}
                    ...
                    <div className='mb-4'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>Address:</label>
                        <input
                            type='text'
                            value={address}
                    ...
                    <div className='mb-4'>
                        <label className='sm:text-sm md:text-xl text-white text-base'>Mobile Number:</label>
                        <input
                            type='text'
                            value={mobile}
